...
export function VideoModal({ video, onClose }: VideoModalProps) {
  ...
  return <div aria-label={video.title} aria-modal="true" className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 p-8 backdrop-blur-[10px]" onClick={onClose} role="dialog">
