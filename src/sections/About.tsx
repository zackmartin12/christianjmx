...
export function About() {
  return <section className="grid min-h-[calc(100vh-57px)] grid-cols-2 max-[700px]:block">
    ...
    <div className="flex flex-col justify-between px-14 py-16 min-[701px]:max-[1000px]:p-12 max-[700px]:px-8 max-[700px]:py-12">
      <div>
      ...
      <div className="mt-10 flex flex-col gap-3 border-t border-[rgb(210_215_218_/_9%)] pt-8 text-sm text-[rgb(224_226_228_/_80%)]">
        <a className="flex w-fit items-center gap-3 hover:text-[#e0e2e4]" href="mailto:videographychristian@gmail.com"><Icon>✉</Icon>videographychristian@gmail.com</a>
        <span className="flex w-fit items-center gap-3"><Icon>☎</Icon>828-606-2372</span>
        <span className="flex w-fit items-center gap-3"><Icon>⌖</Icon>Asheville & Wilmington, NC</span>
